...
Also ensure that the /app/build.gradle specifies that the project uses appcompat - this is used to give the user information about location permissions. Just add a reference to it in the /app/build.gradle:
